...
type Person struct {
	ActiveCustomerExpiresAt               *NationDate `json:"active_customer_expires_at,omitempty"`
	ActiveCustomerStartedAt               *NationDate `json:"active_customer_started_at,omitempty"`
	AuthorID                              uint        `json:"author_id,omitempty"`
	Author                                *Person     `json:"author,omitempty"`
	AutoImportID                          uint        `json:"auto_import_id,omitempty"`
	Availability                          *NationDate `json:"availability,omitempty"`
	BannedAt                              *NationDate `json:"banned_at,omitempty"`
	BillingAddress                        *Address    `json:"billing_address,omitempty"`
	Bio                                   string      `json:"bio,omitempty"`
	BirthDate                             *NationDate `json:"birthdate,omitempty"`
	...
	CreatedAt                             *NationDate `json:"created_at,omitempty"`
	...
	LastContactedAt                       *NationDate `json:"last_contacted_at,omitempty"`
	LastContactedBy                       *Person     `json:"last_contacted_by,omitempty"`
	LastDonatedAt                         *NationDate `json:"last_donated_at,omitempty"`
	LastFundraisedAt                      *NationDate `json:"last_fundraised_at,omitempty"`
	LastInvoiceAt                         *NationDate `json:"last_invoice_at,omitempty"`
	LastName                              string      `json:"last_name,omitempty"`
	LastRuleViolationAt                   *NationDate `json:"last_rule_violation_at,omitempty"`
	...
	MembershipExpiresAt                   *NationDate `json:"membership_expires_at,omitempty"`
	MembershipLevelName                   string      `json:"membership_level_name,omitempty"`
	MembershipStartedAt                   *NationDate `json:"membership_started_at,omitempty"`
	...
	RegisteredAt                          *NationDate `json:"registered_at,omitempty"`
	...
	TwitterUpdatedAt                      *NationDate `json:"twitter_updated_at,omitempty"`
	TwitterWebsite                        string      `json:"twitter_website,omitempty"`
	UnsubscribedAt                        *NationDate `json:"unsubscribed_at,omitempty"`
...
func (n *NationbuilderClient) PushPerson(person *Person, options *Options) (pushedPerson *Person, result *Result) {
...
// Retrieve a person
func (n *NationbuilderClient) GetYourself(options *Options) (person *Person, result *Result) {
